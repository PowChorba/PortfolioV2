                ...
                <main className={s.main}>
                    <div className={s.divBtns}>
                        ...
                        <div className={s.description}>
                            <span>Description</span>
                                ...
                                {/* RobotizeWeb */}
                                <p className={spicy ? s.asd : s.displayNone}>RobotizeWeb es un diario virtual actualizado, es decir, que cuenta con noticias de ultimo momento creadas a traves de CHATGPT. Esta desarrollada con NextJS, NestJS, MongoDB y Python para la creacion de los articulos</p>
                                {/* SPICYBETS */}
                    ...
                    <div className={s.video}>
                        ...
                        <div className={spicy ? s.divButtons : s.displayNone}>
                            <button><a href="https://github.com/PowChorba/RobotizeWeb" rel="noreferrer" target='_blank'><BsGithub/>{' '}Codigo Fuente</a></button>
                            <button><a href="https://robotize-web.vercel.app/home" rel="noreferrer" target='_blank'><FiExternalLink/>{' '}Deploy</a></button>
                        </div>
